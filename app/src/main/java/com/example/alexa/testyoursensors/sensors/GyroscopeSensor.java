...
public class GyroscopeSensor extends Activity {
    ...
    private SensorEventListener gyroscopeEventListenere;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gyroscopeEventListenere = new SensorEventListener() {
            @Override
    ...
    protected void onResume() {
        super.onResume();
        sensorManager.registerListener(gyroscopeEventListenere, gyroscopeSensor, SensorManager.SENSOR_DELAY_FASTEST);
    }

    @Override
    protected void onPause() {
        super.onPause();
        sensorManager.unregisterListener(gyroscopeEventListenere);
    }
}
